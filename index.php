...
$email=$_POST['email'];
$pass=$_POST['pass'];
$sql1="SELECT emailID FROM `registration`";
...
if($email==$rw1[0])
{
   ...
   // echo "<center style='color:red';> * User Already Exists </center>";
}
}
$sql="INSERT INTO `registration`(`uName`, `lName`, `emailID`, `pass`) VALUES  ('$fname','$lname','$email','$pass')"; 
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">  <input type="submit" class="btn btn-primary btn-block" name="btn"></div>
                                            </div>
                                        </form>
                                    </div>
