...
{			
    ...
    $password = $_POST['pass'];  
        ...
        $sql = "SELECT * FROM `registration` WHERE emailID = '$username' and pass = '$password'";  
        ...
        $count = mysqli_num_rows($result);  
		  ...
		  {
			  echo "<center style='color:red';> * Enter Data </center>";  
		  }
		  else{
				if($count == 1){  
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
												...
												<button class="btn btn-primary btn-block" name="btn" href="">Login</button>
